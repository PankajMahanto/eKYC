...
tf.compat.v1.disable_eager_execution()  # TF1 মতো behavior চালু করার জন্য
...
from facenet.models import facenet
# from facenet.models import inception_resnet_v1 
from facenet.models import inception_resnet_v1 as tf_mdl
from facenet.models.utils import detect_face
...
def tensorflow2pytorch():
    ...
    tf_mdl_dir = 'F:/Project/eKYC/facenet/data/20180402-114759'
    data_name = 'vggface2'
    ...
    tf_mdl_dir = 'F:/Project/eKYC/facenet/data/20180408-102900'
